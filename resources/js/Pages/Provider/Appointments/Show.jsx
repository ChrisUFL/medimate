...
const Show = ({id, first_name, last_name, doctor, dateTime}) => {
 ...
 const edit = () => {
  router.get(route('appointments.edit', {
    appointment: id,
  }, false))
 }

 const destroy = () => {
    router.delete(route('appointments.destroy', {
      appointment: id,
    }, false))
 }
        ...
        <div className='w-96'>
            <ShadowBox styles={'h-[400px] py-8'}>
                ...
                <div className='mt-4'>
                    ...
                    <TextInput value={doctor} readOnly={true} className='w-[100%]'/>
                </div>
                <div className='mt-4'>
                    <InputLabel value='Date' htmlFor='date' />
                    <TextInput type='date' name='date' value={date} readOnly={true} className='w-[100%]' />
                </div>
                <div className='mt-4'>
                    <InputLabel value='Appointment Time' htmlFor='time' />
                    <TextInput type='time' name='time' value={time} readOnly={true} className='w-[100%]' />
                </div>
