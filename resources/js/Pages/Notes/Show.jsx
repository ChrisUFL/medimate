...
function Show({...note}) {
    ...
    const deleteNote = (e) => {
        e.preventDefault();
        router.delete(route('notes.destroy', {
            note: note.note_id,
        }, false));
    };
  ...
  return (
    <SimpleLayout>
        ...
        <div className='flex justify-end gap-2'>
            {page.props.auth.user && page.props.auth.user.id === note.note_owner && <PrimaryButton onClick={goToEdit}>Edit</PrimaryButton>}
            {page.props.auth.user && page.props.auth.user.id === note.note_owner && <DangerButton onClick={confirmUserDeletion}>Delete</DangerButton>} 
