  ...
  if (user !== undefined) {
    ...
    return (
      ...
      <section className="title flex-col m-auto justify-center px-10 max-w-[1280px]">
        ...
        <ContentTile data={ data } dataType="calendar" color="bg-indigo-300" />
        <ContentTile data={ data } dataType="medication" color="bg-indigo-400" />
        <ContentTile data={ data } dataType="calendar" color="bg-indigo-500" />
        <ContentTile data={ data } dataType="calendar" color="bg-indigo-600" />
        </div>
    </section>
    )
  }
